    ...
    try {
      switch(options.protocol) {
        ...
        case 'docker':
          ...
          shell = [ path.resolve(__dirname, '../bin/wrapper.sh'), path.resolve(__dirname), options.container ];
        break;

        case 'dockerLogs':
          shell = conf.dockerShell? conf.dockerShell(options) : [ 'docker', 'logs', '-f', options.container ];
          break;
      ...
      return "/sbin/nologin"; // Safe default
    }
  }
